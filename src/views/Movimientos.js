...
import InformacionMovimiento from "../components/InformacionMovimiento";
  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        ...
        <InformacionMovimiento open={this.state.open} />
        {/**El boton flotante */}
        <FloatButton />
      </div>
    );
...
export default withStyles(styles)(Movimientos);
